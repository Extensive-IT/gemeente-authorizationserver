...
INSERT INTO `accounts` (`id`, `registration_reference`, `salutation`, `address`, `postal_code`, `city`, `email`) VALUES
(uuid(), 'NL-123', 'Mr. Joe', 'Testbeulevard 23', '1234 AB', 'Amsterdam', 'test@test123.com'),
(uuid(), 'NL-124', 'Mrs. Sarah', 'Testbeulevard 231', '1235 AC', 'Den-Haag', 'test@test123.com'),
(uuid(), 'NL-125', 'Mr. NotRegistered', 'Testbeulevard 232', '1236 AD', 'Rotterdam', 'notregistered@test123.com');
